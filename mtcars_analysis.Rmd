...
getTStats <- function(x1,x2,printLabel)
{
  ...
  print(paste0(printLabel,": ",round(diffMU,2)))
...
p.value <- getTStats(x1,x2,"Difference in Means")
p.value.adj <- getTStats(x1.adj,x2.adj,"Difference in Means on Adjustment")
```
...
## Box Plot
```{r, boxPlots, echo=FALSE, warning=FALSE, results='hide', message=FALSE, fig.height=4}
figure.box <- ggarrange(plotVS, plotCYL, plotGEAR, plotCARB, ncol = 2, nrow = 2)
figure.box
```

## Heat Map
```{r, heatMapDisplay, echo=FALSE, warning=FALSE, results='hide', message=FALSE, fig.height=4}
heatMap
```

## Adjustment Plots
```{r, adjustmentPlotDisplay, echo=FALSE, warning=FALSE, results='hide', message=FALSE, fig.height=4}
...
## Residual Plot
```{r, residualPlot, echo=FALSE, warning=FALSE, results='hide', message=FALSE, fig.height=4}
